import { Component, ElementRef, Renderer2, ViewChild, AfterViewInit, HostListener, OnDestroy } from '@angular/core';
...
export class OrbThreeComponent implements AfterViewInit, OnDestroy {
